---
layout: post
blog_id: "cropper-header-mobile"
title: "cropper.js 实现裁剪图片并上传(移动端) "
date: 2017-08-26 00:00:00 -0700
tags: Javascript
category: Javascript
summary: 上一篇文章已经编写了PC端的裁剪图片案例，这次是涉及移动端的头像裁剪更换，类似于微信更换头像功能
comments: false
---

上一篇文章已经编写了PC端的裁剪图片案例，这次是涉及移动端的头像裁剪更换，类似于微信更换头像功能。。。

[案例下载](http://download.csdn.net/download/kesixin/9951656)
